<template>
  <div class="sobre" id="sobre">
    ...
    <h3>
      ...
      Criado Integralmente por mim, ele foi feito para funcionar como uma forma rápida e fácil de guardar pequenos lembretes.
      É claro, esta é apenas a primeira versão dele e ainda tem muito o que melhorar, penso em aperfeiçoá-lo aos poucos, 
      enquanto melhoro minhas próprias habilidades como programador e eventualmente colocá-lo online,
    </h3>
    <br>
    <h3>
      Embora simples, ele é um crud completo, podendo criar, ler, editar e deletar informações de um banco de dados funcional e persistente.
      (Bom, Mais ou menos, o heroku zera o banco de tempo em tempo, Afinal, Neste momento ele roda apenas num modo de Visualização, para portfólio mesmo.)
    </h3>
    ...
    <ul>
      ...
      <li>[ ] Criaçao e validação de login </li>
      <li>[ ] Validação de contas (google,facebook) </li>
      <li>[ ] Post-its redimensionavéis </li>
      <li>[ ] Post-its arrastavéis e reorganizavéis </li>
      <li>[ ] Melhorar as transições das animações </li>
      <li>[ ] Responsividade </li>
      <li>[ ] Versão Mobile (App) </li>
    </ul>
